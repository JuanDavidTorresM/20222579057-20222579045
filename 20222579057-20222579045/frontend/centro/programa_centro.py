...
app.layout = html.Div([
    html.H3("Gráfica de Curva Granulométrica"),
    dcc.Graph(
        id='granulometric-curve',  # ID único para el componente dcc.Graph
        # Aquí puedes pasar tus datos y configuraciones de gráfica
    )
])